...
probe -create -database xcelium.shm \$uvm:{uvm_test_top.master_agent.monitor}.vif -all -depth  2

simvision -input /project/uvma/users/ayalamu/ws/UVMA_v1_2_5_rev2/uvm/apb/tb/.simvision/76755_ayalamu__autosave.tcl.svcf
